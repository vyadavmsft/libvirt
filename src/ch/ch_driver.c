...
static virHypervisorDriver chHypervisorDriver = {
    ...
    .connectSupportsFeature = chConnectSupportsFeature,     /* 7.3.0 */
    ...
    .domainOpenConsole = chDomainOpenConsole,               /* 7.3.0 */
    .domainGetVcpus = chDomainGetVcpus,                     /* 7.3.0 */
    .domainGetVcpusFlags = chDomainGetVcpusFlags,           /* 7.3.0 */
    .domainGetMaxVcpus = chDomainGetMaxVcpus,               /* 7.3.0 */
    .domainGetVcpuPinInfo = chDomainGetVcpuPinInfo,         /* 7.3.0 */
    .domainPinVcpu = chDomainPinVcpu,                       /* 7.3.0 */
    .domainPinVcpuFlags = chDomainPinVcpuFlags,             /* 7.3.0 */
    .domainPinEmulator = chDomainPinEmulator,               /* 7.3.0 */
    .domainGetEmulatorPinInfo = chDomainGetEmulatorPinInfo, /* 7.3.0 */
    .nodeGetCPUMap = chNodeGetCPUMap,                       /* 7.3.0 */
    .domainSetNumaParameters = chDomainSetNumaParameters,   /* 7.3.0 */
    .domainGetNumaParameters = chDomainGetNumaParameters,   /* 7.3.0 */
    .domainSetVcpusFlags = chDomainSetVcpusFlags,           /* 7.3.0 */
    .domainGetAutostart = chDomainGetAutostart,             /* 7.3.0 */
    .domainSetAutostart = chDomainSetAutostart,             /* 7.3.0 */
    .domainSetVcpus = chDomainSetVcpus,                     /* 7.3.0 */
};
